...
if __name__ == '__main__':
    ...
    from si.neural_networks.losses import MeanSquaredError, CategoricalCrossEntropy, BinaryCrossEntropy
    from si.metrics.mse import mse
    ...
    model.fit(dataset.X, dataset.y, epochs=100, batch_size=16)
    score = model.evaluate(dataset.X, dataset.y, batch_size=16)
    print(score)
